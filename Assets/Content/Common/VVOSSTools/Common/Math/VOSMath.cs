...
public sealed class VOSMath
{

	public static CommonFraction Fraction(int __numerator, int __denominator)
	{
		var fr = new CommonFraction(__numerator, __denominator);
		return fr;
	}

	[System.Serializable]
	public struct CommonFraction
	{
		public int numerator;
		public int denominator;

		public CommonFraction(int __numerator, int __denominator)
		{
